...
come from the validator-owned fixture set in cathedral.v2.jobs.fixtures.
...
from cathedral.v2.validator.tools import _parse_module_name, _run_python_test
...
def test_run_python_test_timeout() -> None:
    ...
    import cathedral.v2.validator.tools as tools
