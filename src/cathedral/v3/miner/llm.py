...
Chutes (or any OpenAI-compatible) endpoint via env:
    ...
    CATHEDRAL_V3_LLM_BASE_URL   default: https://llm.chutes.ai/v1
    CATHEDRAL_V3_LLM_API_KEY    required for live calls
    CATHEDRAL_V3_LLM_MODEL      default: MiniMax-M2.5-TEE
"""
...
class LLMAgent:
    ...
    def __init__(
        ...
        self.base_url = base_url or os.environ.get(
            "CATHEDRAL_V3_LLM_BASE_URL", "https://llm.chutes.ai/v1"
        )
        self.api_key = api_key or os.environ.get("CATHEDRAL_V3_LLM_API_KEY")
        self.model = model or os.environ.get("CATHEDRAL_V3_LLM_MODEL", "MiniMax-M2.5-TEE")
