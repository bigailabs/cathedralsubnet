...
from cathedral.v3.receipt import (
    ReceiptSigner,
    load_or_create_signing_key,
    verify_receipt,
)
from cathedral.v3.replay import replay
from cathedral.v3.runtime import Runtime, default_home, miner_by_name
from cathedral.v3.scoring import compute_weights
from cathedral.v3.types import TaskType
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(
        prog="cathedral-v3", description="Cathedral v3 — agentic workforce trajectory substrate"
    )
    p.add_argument("--home", help="Override CATHEDRAL_V3_HOME for this command.")
