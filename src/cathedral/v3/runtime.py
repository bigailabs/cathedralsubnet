...
from cathedral.v3.jobs import JobGenerator
...
from cathedral.v3.receipt import ReceiptSigner, load_or_create_signing_key
from cathedral.v3.scoring import WeightLoop, score_trajectory
from cathedral.v3.types import JobSpec, TaskType, Trajectory, Weights
from cathedral.v3.validator.observer import Validator


def default_home() -> Path:
    return Path(os.environ.get("CATHEDRAL_V3_HOME") or (Path.home() / ".cathedral" / "v3"))
